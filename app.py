...
from dotenv import load_dotenv # NUEVO: Para leer variables de entorno
...
# --- CONFIGURACIÓN GEMINI AI (MODIFICADO PARA .ENV) ---
# Ahora la clave se busca en las variables del servidor, no en el código
...
if api_key:
    ...
    # Esto evitará que la app se rompa si falta la clave, pero avisará en los logs
...
def chat_ai():
    ...
    try:
        ...
        return jsonify({'error': 'Error procesando solicitud AI'}), 500
